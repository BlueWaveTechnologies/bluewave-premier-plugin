...
public class Premier {
  ...
  //** download
  //**************************************************************************
    public static void download(HashMap<String, String> args) throws Exception {
        new Premier(args.get("-username"), args.get("-password"))
  ...
  //**************************************************************************
    public static void test(HashMap<String, String> args) throws Exception {
        testConnect(args.get("-username"), args.get("-password"));
    }
